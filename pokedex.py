...
#This is the script you run to call the google_vit_pokemon_classification model. Here is an example command
#Python3 pokedex.py pokemon_lion.png, which will take the pokemon_lion.png and output the pokemon Litleo.
...
def main(image_path):
    ...
    try:
        ...
        model = ViTForImageClassification.from_pretrained("models/google_vit_pokemon_classification")
